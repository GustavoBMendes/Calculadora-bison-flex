...
{
  "$end", "error", "$undefined", "INTEIRO", "FLOAT", "ID", "MAIS",
  "MENOS", "VEZES", "DIVIDE", "POTENCIA", "VIRGULA", "IGUAL", "E_PAR",
  "D_PAR", "PRINT", "N_LINHA", "$accept", "entrada", "line", "iexp",
  "fexp", YY_NULLPTR
};
#endif
...
{
     -11,    31,   -11,   -11,   -11,   -10,    72,    72,   -11,   -11,
      32,    43,    72,   -11,    84,    88,    47,    58,    72,    72,
      72,    72,   -11,    72,    72,    72,    72,   -11,    62,    73,
     -11,   -11,   -11,   -11,    -5,    -1,    -5,    -1,   -11,   -11,
     -11,   -11,    -5,    -1,    -5,    -1,   -11,   -11,   -11,   -11,
     -11,   -11
};
...
{
       2,     0,     1,    11,    18,    12,     0,     0,     4,     3,
       0,     0,     0,    12,     0,     0,     0,     0,     0,     0,
       0,     0,     6,     0,     0,     0,     0,     5,     0,     0,
      17,    24,     9,    10,    13,    25,    14,    26,    15,    27,
      16,    28,    29,    20,    30,    21,    31,    22,    32,    23,
       7,     8
};
...
{
      14,    16,    12,    20,    21,     0,    28,    25,    26,     0,
      15,    17,    34,    36,    38,    40,    29,    42,    44,    46,
      48,     0,    35,    37,    39,    41,     0,    43,    45,    47,
      49,     2,     0,     0,     3,     4,     5,     0,    18,    19,
      20,    21,     0,     0,     6,     0,     7,     8,    22,    23,
      24,    25,    26,    18,    19,    20,    21,     0,     0,    27,
       0,     0,     0,    32,    23,    24,    25,    26,    18,    19,
      20,    21,     0,     0,    33,     3,     4,    13,    50,    23,
      24,    25,    26,     0,     0,     6,     0,     0,     0,    51,
      18,    19,    20,    21,    23,    24,    25,    26,    30,     0,
       0,     0,    31
};

static const yytype_int8 yycheck[] =
{
       6,     7,    12,     8,     9,    -1,    12,     8,     9,    -1,
       6,     7,    18,    19,    20,    21,    12,    23,    24,    25,
      26,    -1,    18,    19,    20,    21,    -1,    23,    24,    25,
      26,     0,    -1,    -1,     3,     4,     5,    -1,     6,     7,
       8,     9,    -1,    -1,    13,    -1,    15,    16,    16,     6,
       7,     8,     9,     6,     7,     8,     9,    -1,    -1,    16,
      -1,    -1,    -1,    16,     6,     7,     8,     9,     6,     7,
       8,     9,    -1,    -1,    16,     3,     4,     5,    16,     6,
       7,     8,     9,    -1,    -1,    13,    -1,    -1,    -1,    16,
       6,     7,     8,     9,     6,     7,     8,     9,    14,    -1,
      -1,    -1,    14
};
...
{
       0,    18,     0,     3,     4,     5,    13,    15,    16,    19,
      20,    21,    12,     5,    20,    21,    20,    21,     6,     7,
       8,     9,    16,     6,     7,     8,     9,    16,    20,    21,
      14,    14,    16,    16,    20,    21,    20,    21,    20,    21,
...
#line 45 "bison.y" /* yacc.c:1646  */
    {updateSymbolVal((yyvsp[-3].id), (yyvsp[-1].ival));
                                     printf("Resultado %c = %d", (yyvsp[-3].id), (yyvsp[-1].ival));}
#line 1290 "bison.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 47 "bison.y" /* yacc.c:1646  */
    {updateSymbolVal((yyvsp[-3].id), (yyvsp[-1].fval));}
...
#line 52 "bison.y" /* yacc.c:1646  */
    {(yyval.ival) = symbolVal((yyvsp[0].id));}
...
#line 60 "bison.y" /* yacc.c:1646  */
    {(yyval.fval) = symbolVal((yyvsp[0].id));}
